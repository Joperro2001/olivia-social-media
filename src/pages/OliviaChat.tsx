...
const OliviaChat: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-10rem)]">
      ...
      <div className="flex-1 overflow-y-auto pb-4 px-2">
        {messages.map((message) => (
          <ChatBubble
            ...
            avatar={!message.isUser ? "https://api.dicebear.com/7.x/thumbs/svg?seed=olivia" : undefined}
          />
        ))}
      ...
      <div className="p-4 bottom-0 fixed w-full max-w-[calc(100vw-2rem)] md:max-w-[calc(1280px-2rem)]">
